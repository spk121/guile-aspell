  ...
  if (!ret)
    {
      scm_misc_error ("aspell-add-word",
		      aspell_speller_error_message (c_speller),
		      SCM_BOOL_F);
    }
  ...
  if (first)
    {
      ...
      speller_tag = scm_make_smob_type ("speller",
					sizeof (AspellSpeller *));
      ...
      scm_c_define_gsubr ("aspell-new-speller", 0, 0, 0,
			  gu_aspell_new_speller);
      scm_c_define_gsubr ("aspell-set-lang", 1, 0, 0,
			  gu_aspell_set_lang);
      scm_c_define_gsubr ("aspell-word", 1, 1, 0,
			  gu_aspell_word);
      scm_c_define_gsubr ("aspell-correct?", 1, 1, 0,
			  gu_aspell_correct_p);
      scm_c_define_gsubr ("aspell-add-word", 1, 1, 0,
			  gu_aspell_add_word);
      scm_c_define_gsubr ("aspell-store-replacement", 2, 1, 0,
			  gu_aspell_store_replacement);


      default_speller = _scm_to_speller (gu_aspell_new_speller ());
      first = 0;
    }
}
